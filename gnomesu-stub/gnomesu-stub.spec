...
%description
This is the stubbed out version of gnomesu which supports sudo and locked root
accounts. It uses lxqt-sudo and provides primitive abstraction for xdg-su to use
